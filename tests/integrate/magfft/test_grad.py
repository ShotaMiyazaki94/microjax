...
ax["C"].set_xlabel("u")
plt.savefig("tests/integrate/magfft/test_grad_1.png",dpi=200,bbox_inches="tight")
plt.close()
...
ax[1].set_xlabel("u")
ax[1].set_ylabel("rho")
plt.savefig("tests/integrate/magfft/test_grad_2.png",dpi=200,bbox_inches="tight")
plt.close()
