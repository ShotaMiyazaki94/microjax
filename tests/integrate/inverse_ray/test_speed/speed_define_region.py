...
from microjax.inverse_ray.merge_area import calc_source_limb
...
for Nlimb in Nlimbs:
    ...
    r_scan, th_scan = jit(define_regions)(image_limb, mask_limb, rho)
...
plt.title("Speed of define_regions")
plt.savefig('tests/integrate/inverse_ray/test_speed/speed_define_region.pdf', bbox_inches="tight")
plt.show()
