"""Numerical constants for the fixed Gauss/Kronrod and Gauss rules."""
...
GK31_X = np.concatenate((-_GK31_X_POSITIVE_DESC[:-1], _GK31_X_POSITIVE_DESC[::-1]))
GK31_W = _symmetric(_GK31_W_POSITIVE_DESC)
G15_W_ON_GK31 = _symmetric(_G15_W_POSITIVE_DESC)

# Optional independent high-order one-cell rules. Their 70 total nodes remain
# cheaper than uniform radial subdivision when a caller needs sharper interior
