...
plot_boundary_construction(
    ...
    limb_darkening=u1,
    output_path=Path("example/gpu/compare-binary-vbbl/compare_binary_uniform_max_residual_icrs.png"),
)
...
fig.savefig("example/gpu/compare-binary-vbbl/compare_binary_uniform.png", dpi=200)
print("output: example/gpu/compare-binary-vbbl/compare_binary_uniform.png")
plt.close()
